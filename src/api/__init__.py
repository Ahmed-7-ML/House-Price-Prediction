"""
    Pydantic Schemas for Request and Response for Validation.
"""

from pydantic import BaseModel, Field

# ---> Define the Request/Input Format as a Model Input
...
# ---> Define the Response/Output as a Model Output
def PredictionResponse(BaseModel):
    predicted_price = Field(..., description="Predicted median house value (×$100k)")
